...
- Este manual é ilustrativo. Onde aparece [Figura], insira um print de tela correspondente.
...
---
Observação: insira imagens de tela nas marcações [Figura] para tornar o manual visual. Recomenda-se salvar prints em `archive/manual/img/` e referenciar no documento (por ex., `![Login](../manual/img/login.png)`).
