...
export function ComparisonBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-slate-200 shadow-2xl transform transition-transform duration-300 ease-in-out">
