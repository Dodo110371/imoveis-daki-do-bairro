   ...
   return (
     <div className="min-h-screen bg-slate-100 py-10 px-4 print:p-0 print:bg-white">
       ...
       <div className="flyer-a4 w-[210mm] min-h-[297mm] mx-auto bg-white shadow-2xl overflow-hidden flex flex-col print:shadow-none print:m-0 print:rounded-none relative">
        ...
        {/* Header Section (tela) */}
        <div className="flyer-header bg-slate-900 text-white p-12 print:hidden text-center relative overflow-hidden">
        ...
        {/* Header Section (print simplificado) */}
        <div className="hidden print:block p-4 border-b border-slate-300">
          <div className="flex items-center justify-center gap-6">
            ...
            />
            <h1 className="flex flex-col items-start text-left">
              <span className="font-sans font-extrabold text-5xl tracking-tight mb-2 leading-none text-slate-900">Imóveis</span>
              <span className="font-sans font-medium text-2xl text-slate-700 leading-none">daki do Bairro</span>
            </h1>
          </div>
        </div>
